...
class RadioImage extends GetFields {
	...
	public function get_field() {
		if ( $this->field && is_array( $this->field ) ) {
			...
			?>
			<div id="field-<?php echo esc_attr( $id ); ?>" class="fields-wrapper radio-image flex-wrap <?php echo esc_attr( $class ); ?>" data-col="<?php esc_attr( $column ); ?>"  data-conditional-rules="<?php echo esc_attr( $attr ); ?>" >
				<div class="label col">
