 ...
 * @return mixed
 */
function get_tiny_meta( $post_id = null ) {
	return tinyfield()->get_tiny_meta( $post_id );
}

/**
 * Undocumented function
 *
 * @param [type] $field_id Meta post id.
 * @param [type] $post_id Meta post id.
 * @return mixed
 */
function get_tiny_meta_by_id( $field_id, $post_id = null ) {
	return tinyfield()->get_tiny_meta_by_id( $field_id, $post_id );
}
